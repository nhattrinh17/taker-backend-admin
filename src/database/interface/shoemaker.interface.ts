...
export interface ShoemakerRepositoryInterface extends BaseRepositoryInterface<Shoemaker> {
  ...
  findAllCustom(search: string, referralCode: string, status: string, isVerified: number, isAvailable: number, pagination: PaginationDto, sort: string, typeSort: 'ASC' | 'DESC'): Promise<any>;
